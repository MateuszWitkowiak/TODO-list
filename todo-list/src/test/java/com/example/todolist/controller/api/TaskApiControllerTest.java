...
class TaskApiControllerTest {
    ...
    void setUp() {
        ...
        getTaskResponse1 = new GetTaskResponse(
                taskId1,
                "Test 1",
                null,
                null,
        ...
        getTaskResponse2 = new GetTaskResponse(
                taskId2,
                "Test 2",
                null,
                null,
    ...
    void shouldReturnTaskById() throws Exception {
        ...
        // when / then
        mockMvc.perform(get(BASE_URL + "/" + taskId1))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void shouldReturnFilteredTasksOnSearch() throws Exception {
        ...
        when(taskService.searchTasksByTitle("Hello", 0, 10))
                .thenReturn(List.of(taskHello));
        when(taskMapper.mapToGetTaskResponse(List.of(taskHello)))
                .thenReturn(List.of(helloResponse));
    ...
    void shouldCreateTask() throws Exception {
        ...
        CreateTaskResponse createResponse =
                new CreateTaskResponse(createdTaskId, "New task", null, Status.TODO, null, categoryId, userId);

        when(taskService.createTask(any(CreateTaskRequest.class)))
                .thenReturn(createdTask);
        when(taskMapper.mapToCreateTaskResponse(createdTask))
    ...
    void shouldUpdateTask() throws Exception {
        ...
        when(taskService.updateTask(any(UUID.class), any(UpdateTaskRequest.class)))
                .thenReturn(updated);
        when(taskMapper.mapToGetTaskResponse(updated))
                .thenReturn(response);
