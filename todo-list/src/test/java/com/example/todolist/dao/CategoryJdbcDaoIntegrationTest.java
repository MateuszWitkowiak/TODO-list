...
class CategoryJdbcDaoIntegrationTest {
    ...
    void setUpSchema() {
        ...
        jdbcTemplate.update("INSERT INTO users (id, email, password, role) VALUES (?, ?, ?, ?)", userId.toString(), "cat@test.com", "passcat", "USER");
    }
    ...
    void findAllByUserId_ShouldReturnCategories() {
        ...
        assertTrue(categories.stream().allMatch(c -> c.getUser() != null && c.getUser().getId().equals(userId)));
    }
